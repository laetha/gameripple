...
if (!empty($_GET['id'])) {
  ...
  if (!in_array($tmp_action, $disallowed_paths) /*&& file_exists("world/{$tmp_action}.php")*/)
        $id = $tmp_action;
        $id = addslashes($id);
        $worldedit = "SELECT * FROM tv WHERE uid LIKE '$id'";
...
?>
        ...
        <div class="col-md-10 col-centered">
         <div class="col-sm-6 typebox col-centered" id="name">
             <form method="post" action="tveditprocess.php" id="import" enctype="multipart/form-data">
...
<?php
       ...
       <a class="clean" href="/tv.php?id=<?php echo $id; ?>"><button class="btn btn-danger col-centered inline" type="button">Cancel</button></a>
       </div>
      </form>
