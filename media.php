   ...
   <table id="library" class="table table-condensed table-striped table-responsive dt-responsive" cellspacing="0" width="100%">
           ...
           <tbody>
             <?php
               ...
               $sentiments = 0;
               $sqlcompendium1 = "SELECT * FROM sentiments WHERE uid LIKE '$uid'";
             ...
             $sqlcompendium = "SELECT * FROM books WHERE active=1";
               $compendiumdata = mysqli_query($dbcon, $sqlcompendium) or die('error getting data');
               while($row = mysqli_fetch_array($compendiumdata, MYSQLI_ASSOC)) {
               echo ('<tr>');
               $title = $row['title'];
             ...
             $sqlcompendium = "SELECT * FROM movies WHERE active=1";
             $compendiumdata = mysqli_query($dbcon, $sqlcompendium) or die('error getting data');
             while($row = mysqli_fetch_array($compendiumdata, MYSQLI_ASSOC)) {
             echo ('<tr>');
             $title = $row['title'];
           ...
           $sqlcompendium = "SELECT * FROM tv WHERE active=1";
           $compendiumdata = mysqli_query($dbcon, $sqlcompendium) or die('error getting data');
           while($row = mysqli_fetch_array($compendiumdata, MYSQLI_ASSOC)) {
           echo ('<tr>');
           $title = $row['title'];
